...
def check_1(lst_obj):
    ...
    Сложность: O(len(lst_obj)) зависит от объема входящих данных.
    """
    lst_to_set = set(lst_obj)  # O(len(lst_obj)) зависит от объема входящих данных
...
def check_2(lst_obj):
    ...
    """
    for j in range(len(lst_obj)):          # O(n) + O(1) в итоге линейная
...
def check_3(lst_obj):
    ...
    """
    lst_copy = list(lst_obj)                 # O(len(lst_obj)) зависит от объема входящих данных
